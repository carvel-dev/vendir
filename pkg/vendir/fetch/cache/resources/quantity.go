...
// File imported from https://github.com/kubernetes/apimachinery/blob/master/pkg/api/resource/quantity.go at commit 117bd9b
/*
...
func (Quantity) OpenAPISchemaType() []string { return []string{"string"} } // carvel: Lint change

// OpenAPISchemaFormat is used by the kube-openapi generator when constructing
// the OpenAPI spec of this type.
func (Quantity) OpenAPISchemaFormat() string { return "" } // carvel: Lint change
